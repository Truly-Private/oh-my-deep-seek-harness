...
**Declare the supplied artwork maskable.** Rejected because arbitrary masking can remove meaningful parts of the circular emblem. A future maskable variant requires purpose-built safe-zone artwork rather than relabelling the current image.
