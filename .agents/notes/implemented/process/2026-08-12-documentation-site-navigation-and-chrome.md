...
The documentation wordmark remains a documentation-site asset with theme-following vector fills. The Web product surface and browser icon use the separately supplied raster artwork, so changing either identity asset does not silently change the other.
