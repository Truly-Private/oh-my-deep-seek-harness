...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@truly-private/omdsh-agent-loop`.
- No cross-package deep imports (`@truly-private/omdsh-*/src/...` paths) — public entry points only.
