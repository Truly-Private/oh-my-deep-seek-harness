...
import { boot, loadOverlayPatches } from '@truly-private/omdsh-app-boot'
import SystemPrompt from '@truly-private/omdsh-system-prompt'
import ToolRuntime from '@truly-private/omdsh-tools'
import * as McpClient from '@truly-private/omdsh-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@truly-private/omdsh-mcp-client')
