...
import { boot, healProfilesModuleFallback, loadOverlayPatches } from '@truly-private/omdsh-app-boot'
...
import { resolveSessionPreset, SETTINGS_NAMESPACE } from '@truly-private/omdsh-agent-presets'
import { applyChildComposition, childSessionMeta } from '@truly-private/omdsh-subagent'
import { CallId } from '@truly-private/omdsh-llm'
import type {} from '@truly-private/omdsh-compaction-basic'
...
import type {} from '@truly-private/omdsh-token-meter'
...
describe('product subagent rows in user presets', () => {
  ...
  beforeAll(async () => {
    ...
    productCtx = await bootWeb(settingsFile, [
      { insert: [
        { id: 'subagent-codex', name: '@truly-private/omdsh-subagent-codex' },
        { id: 'subagent-claude-code', name: '@truly-private/omdsh-subagent-claude-code' },
      ] },
      {
        id: 'agent-presets',
        config: {
...
describe('a launcher that configures no writable root', () => {
  ...
  beforeAll(async () => {
    ...
    await writeFile(
      ...
      '- id: tool-todo\n  name: \'@truly-private/omdsh-tool-todo\'\n  config:\n    allowParallelInProgress: true\n',
    )
