...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  for (const plugin of ['@truly-private/omdsh-client-ui-layout', '@truly-private/omdsh-client-ui-sidebar', '@truly-private/omdsh-client-ui-conversation', '@truly-private/omdsh-client-ui-tool']) {
