...
import { parseSessionLog } from '@truly-private/omdsh-llm-replay'
import type { SessionEvent, SessionId } from '@truly-private/omdsh-session'
import type {} from '@truly-private/omdsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@truly-private/omdsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@truly-private/omdsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@truly-private/omdsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@truly-private/omdsh-skill-filesystem"}\n',
