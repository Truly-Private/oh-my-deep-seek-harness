...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^@truly-private\/omdsh-client-web$/, replacement: src('../../packages/client/web/src/boot.tsx') },
      { find: /^@truly-private\/omdsh-client-web-react$/, replacement: src('../../packages/client/web-react/src/index.ts') },
      { find: /^@truly-private\/omdsh-client-ui-slots$/, replacement: src('../../packages/client/ui-slots/src/index.ts') },
      { find: /^@truly-private\/omdsh-client-ui-primitives$/, replacement: src('../../packages/client/ui-primitives/src/index.ts') },
      { find: /^@truly-private\/omdsh-client-ui-attachment$/, replacement: src('../../packages/client/ui-attachment/src/index.ts') },
      { find: /^@truly-private\/omdsh-client-schema-form$/, replacement: src('../../packages/client/schema-form/src/index.ts') },
      { find: /^@truly-private\/omdsh-client-modules\/client$/, replacement: src('../../packages/client/modules/src/client/index.ts') },
    ],
  },
  define: {
