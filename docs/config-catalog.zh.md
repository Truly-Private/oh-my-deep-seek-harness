...
<a id="truly-privateomdsh-acp"></a>

## `@truly-private/omdsh-acp`
...
<a id="truly-privateomdsh-acp-demo"></a>

## `@truly-private/omdsh-acp-demo`
...
依赖：[`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#truly-privateomdsh-tools)

来源：[`packages/examples/acp-demo/src/index.ts:39`](../packages/examples/acp-demo/src/index.ts)

<a id="truly-privateomdsh-agent-default-model"></a>

## `@truly-private/omdsh-agent-default-model`
...
<a id="truly-privateomdsh-agent-instructions"></a>
...
<a id="truly-privateomdsh-agent-loop"></a>

## `@truly-private/omdsh-agent-loop`
...
<a id="truly-privateomdsh-agent-presets"></a>

## `@truly-private/omdsh-agent-presets`
...
<a id="truly-privateomdsh-agent-spine-demo"></a>

## `@truly-private/omdsh-agent-spine-demo`
...
依赖：[`AgentLoopConfig`](#truly-privateomdsh-agent-loop) · [`GoalDomainConfig`](#truly-privateomdsh-goal) · [`InvariantConfig`](#truly-privateomdsh-invariants) · [`JobsConfig`](#truly-privateomdsh-jobs-local) · [`SessionTitleConfig`](#truly-privateomdsh-session-title) · [`SkillFileSystem`](../packages/skill/skill-filesystem/src/index.ts) · [`SkillRegistryConfig`](#truly-privateomdsh-skill) · [`SystemPromptConfig`](#truly-privateomdsh-system-prompt) · [`toolBash`](../packages/shell/tool-bash/src/index.ts) · [`toolGoal`](../packages/goal/tool-goal/src/index.ts) · [`toolJobs`](../packages/jobs/tool-jobs/src/index.ts) · [`ToolsConfig`](#truly-privateomdsh-tools) · [`toolSkill`](../packages/skill/tool-skill/src/index.ts) · [`workspaceContext`](../packages/context/agent-instructions/src/index.ts)

来源：[`packages/examples/agent-spine-demo/src/index.ts:92`](../packages/examples/agent-spine-demo/src/index.ts)

<a id="truly-privateomdsh-agent-tool-presentation"></a>

## `@truly-private/omdsh-agent-tool-presentation`
...
<a id="truly-privateomdsh-attachment-local"></a>

## `@truly-private/omdsh-attachment-local`
...
<a id="truly-privateomdsh-bash-local"></a>

## `@truly-private/omdsh-bash-local`
...
<a id="truly-privateomdsh-bash-sandbox"></a>

## `@truly-private/omdsh-bash-sandbox`
 ...
 * on `ctx.sandboxPolicy` (`@truly-private/omdsh-sandbox-policy`), which resolves
...
依赖：[`LocalConfig`](#truly-privateomdsh-bash-local)

来源：[`packages/shell/bash-sandbox/src/index.ts:35`](../packages/shell/bash-sandbox/src/index.ts)

<a id="truly-privateomdsh-client-connection"></a>
...
<a id="truly-privateomdsh-client-hmr"></a>

## `@truly-private/omdsh-client-hmr`
...
<a id="truly-privateomdsh-code-runtime-worker-thread"></a>

## `@truly-private/omdsh-code-runtime-worker-thread`
...
<a id="truly-privateomdsh-compaction-basic"></a>

## `@truly-private/omdsh-compaction-basic`
...
<a id="truly-privateomdsh-compaction-tool-result-pruner"></a>

## `@truly-private/omdsh-compaction-tool-result-pruner`
...
<a id="truly-privateomdsh-cordis-host-runner"></a>

## `@truly-private/omdsh-cordis-host-runner`
...
<a id="truly-privateomdsh-credentials-local"></a>

## `@truly-private/omdsh-credentials-local`
...
<a id="truly-privateomdsh-e2b"></a>

## `@truly-private/omdsh-e2b`
...
<a id="truly-privateomdsh-experimental-agent-team"></a>

## `@truly-private/omdsh-experimental-agent-team`
...
<a id="truly-privateomdsh-experimental-tool-agent-team"></a>

## `@truly-private/omdsh-experimental-tool-agent-team`
...
<a id="truly-privateomdsh-file-reference-local"></a>

## `@truly-private/omdsh-file-reference-local`
...
<a id="truly-privateomdsh-fs-local"></a>

## `@truly-private/omdsh-fs-local`
...
<a id="truly-privateomdsh-fs-sandbox"></a>

## `@truly-private/omdsh-fs-sandbox`
...
依赖：[`LocalConfig`](#truly-privateomdsh-fs-local)

来源：[`packages/fs/fs-sandbox/src/index.ts:49`](../packages/fs/fs-sandbox/src/index.ts)

<a id="truly-privateomdsh-goal"></a>

## `@truly-private/omdsh-goal`
...
<a id="truly-privateomdsh-headless"></a>

## `@truly-private/omdsh-headless`
...
<a id="truly-privateomdsh-hooks-claude-code"></a>

## `@truly-private/omdsh-hooks-claude-code`
...
<a id="truly-privateomdsh-hooks-codex"></a>

## `@truly-private/omdsh-hooks-codex`
...
<a id="truly-privateomdsh-host-apiproxy"></a>

## `@truly-private/omdsh-host-apiproxy`
...
<a id="truly-privateomdsh-host-directory-picker-browse"></a>

## `@truly-private/omdsh-host-directory-picker-browse`
...
<a id="truly-privateomdsh-host-frontend-static"></a>
...
<a id="truly-privateomdsh-host-webserver"></a>
...
<a id="truly-privateomdsh-invariants"></a>

## `@truly-private/omdsh-invariants`
...
<a id="truly-privateomdsh-jobs-local"></a>

## `@truly-private/omdsh-jobs-local`
...
<a id="truly-privateomdsh-llm-deepseek"></a>

## `@truly-private/omdsh-llm-deepseek`
...
<a id="truly-privateomdsh-llm-pi-ai"></a>
...
<a id="truly-privateomdsh-llm-replay"></a>

## `@truly-private/omdsh-llm-replay`
...
<a id="truly-privateomdsh-llm-retry"></a>

## `@truly-private/omdsh-llm-retry`
...
<a id="truly-privateomdsh-lsp-stdio"></a>
...
<a id="truly-privateomdsh-mcp-client"></a>

## `@truly-private/omdsh-mcp-client`
...
<a id="truly-privateomdsh-message-feedback"></a>

## `@truly-private/omdsh-message-feedback`
...
<a id="truly-privateomdsh-permission-presets"></a>

## `@truly-private/omdsh-permission-presets`
...
<a id="truly-privateomdsh-persona"></a>

## `@truly-private/omdsh-persona`
...
<a id="truly-privateomdsh-plan-mode"></a>

## `@truly-private/omdsh-plan-mode`
...
<a id="truly-privateomdsh-pwsh-local"></a>

## `@truly-private/omdsh-pwsh-local`
...
<a id="truly-privateomdsh-pwsh-sandbox"></a>

## `@truly-private/omdsh-pwsh-sandbox`
...
依赖：[`LocalConfig`](#truly-privateomdsh-pwsh-local)

来源：[`packages/shell/pwsh-sandbox/src/index.ts:40`](../packages/shell/pwsh-sandbox/src/index.ts)

<a id="truly-privateomdsh-repeat-tool-reminder"></a>

## `@truly-private/omdsh-repeat-tool-reminder`
...
<a id="truly-privateomdsh-sandbox-local"></a>

## `@truly-private/omdsh-sandbox-local`
...
<a id="truly-privateomdsh-sandbox-policy"></a>

## `@truly-private/omdsh-sandbox-policy`
...
<a id="truly-privateomdsh-sdk-jsonrpc-server"></a>

## `@truly-private/omdsh-sdk-jsonrpc-server`
...
<a id="truly-privateomdsh-session-persistence-jsonl"></a>

## `@truly-private/omdsh-session-persistence-jsonl`
...
<a id="truly-privateomdsh-session-persistence-sqlite"></a>
...
<a id="truly-privateomdsh-session-projection-cache"></a>

## `@truly-private/omdsh-session-projection-cache`
...
<a id="truly-privateomdsh-session-query-sqlite"></a>

## `@truly-private/omdsh-session-query-sqlite`
...
<a id="truly-privateomdsh-session-reference"></a>
...
<a id="truly-privateomdsh-session-telemetry-otel"></a>

## `@truly-private/omdsh-session-telemetry-otel`
...
<a id="truly-privateomdsh-session-title"></a>

## `@truly-private/omdsh-session-title`
...
<a id="truly-privateomdsh-session-title-all-prompts-llm"></a>

## `@truly-private/omdsh-session-title-all-prompts-llm`
...
<a id="truly-privateomdsh-session-title-first-prompt-llm"></a>

## `@truly-private/omdsh-session-title-first-prompt-llm`
...
<a id="truly-privateomdsh-settings-file"></a>

## `@truly-private/omdsh-settings-file`
...
<a id="truly-privateomdsh-shell-env"></a>

## `@truly-private/omdsh-shell-env`
...
<a id="truly-privateomdsh-skill"></a>

## `@truly-private/omdsh-skill`
...
<a id="truly-privateomdsh-skill-filesystem"></a>

## `@truly-private/omdsh-skill-filesystem`
...
<a id="truly-privateomdsh-spill-local"></a>

## `@truly-private/omdsh-spill-local`
...
<a id="truly-privateomdsh-spill-policy"></a>

## `@truly-private/omdsh-spill-policy`
...
<a id="truly-privateomdsh-storage-domain"></a>

## `@truly-private/omdsh-storage-domain`
...
<a id="truly-privateomdsh-storage-json"></a>
...
<a id="truly-privateomdsh-storage-sqlite"></a>

## `@truly-private/omdsh-storage-sqlite`
...
<a id="truly-privateomdsh-subagent-acp"></a>

## `@truly-private/omdsh-subagent-acp`
...
<a id="truly-privateomdsh-subagent-claude-code"></a>
...
<a id="truly-privateomdsh-subagent-codex"></a>
...
<a id="truly-privateomdsh-subagent-dsh-sdk"></a>

## `@truly-private/omdsh-subagent-dsh-sdk`
...
<a id="truly-privateomdsh-subagent-fork-in-process"></a>

## `@truly-private/omdsh-subagent-fork-in-process`
...
<a id="truly-privateomdsh-subagent-spawn-in-process"></a>

## `@truly-private/omdsh-subagent-spawn-in-process`
...
<a id="truly-privateomdsh-subprocess-e2b"></a>

## `@truly-private/omdsh-subprocess-e2b`
...
<a id="truly-privateomdsh-system-prompt"></a>

## `@truly-private/omdsh-system-prompt`
...
<a id="truly-privateomdsh-terminal-bash"></a>

## `@truly-private/omdsh-terminal-bash`
...
<a id="truly-privateomdsh-time-context"></a>

## `@truly-private/omdsh-time-context`
...
<a id="truly-privateomdsh-tmux-context"></a>
...
<a id="truly-privateomdsh-token-meter"></a>

## `@truly-private/omdsh-token-meter`
...
<a id="truly-privateomdsh-tool-bash"></a>

## `@truly-private/omdsh-tool-bash`
...
<a id="truly-privateomdsh-tool-bash-persistent"></a>
...
<a id="truly-privateomdsh-tool-fs"></a>

## `@truly-private/omdsh-tool-fs`
...
<a id="truly-privateomdsh-tool-fs-search"></a>

## `@truly-private/omdsh-tool-fs-search`
...
export interface Config {
   ...
   * `@truly-private/omdsh-tool-call-timeout-policy` through `exec.signal`.
   */
  timeoutMs?: number
}
```
...
<a id="truly-privateomdsh-tool-goal"></a>

## `@truly-private/omdsh-tool-goal`
...
<a id="truly-privateomdsh-tool-jobs"></a>

## `@truly-private/omdsh-tool-jobs`
...
<a id="truly-privateomdsh-tool-lsp"></a>
...
<a id="truly-privateomdsh-tool-pwsh"></a>

## `@truly-private/omdsh-tool-pwsh`
...
<a id="truly-privateomdsh-tool-pwsh-persistent"></a>

## `@truly-private/omdsh-tool-pwsh-persistent`
...
来源：[`packages/shell/tool-pwsh-persistent/src/index.ts:485`](../packages/shell/tool-pwsh-persistent/src/index.ts)

<a id="truly-privateomdsh-tool-ralph"></a>

## `@truly-private/omdsh-tool-ralph`
...
<a id="truly-privateomdsh-tool-session-query"></a>

## `@truly-private/omdsh-tool-session-query`
...
<a id="truly-privateomdsh-tool-skill"></a>

## `@truly-private/omdsh-tool-skill`
...
<a id="truly-privateomdsh-tool-str-replace-editor"></a>

## `@truly-private/omdsh-tool-str-replace-editor`
...
<a id="truly-privateomdsh-tool-subagent"></a>

## `@truly-private/omdsh-tool-subagent`
...
<a id="truly-privateomdsh-tool-subagent-report"></a>

## `@truly-private/omdsh-tool-subagent-report`
...
<a id="truly-privateomdsh-tool-terminal"></a>

## `@truly-private/omdsh-tool-terminal`
...
<a id="truly-privateomdsh-tool-todo"></a>

## `@truly-private/omdsh-tool-todo`
...
<a id="truly-privateomdsh-tool-web"></a>

## `@truly-private/omdsh-tool-web`
...
<a id="truly-privateomdsh-tool-workflow"></a>

## `@truly-private/omdsh-tool-workflow`
...
<a id="truly-privateomdsh-tools"></a>

## `@truly-private/omdsh-tools`
...
<a id="truly-privateomdsh-typert-loader"></a>

## `@truly-private/omdsh-typert-loader`
...
<a id="truly-privateomdsh-user-approval"></a>
...
<a id="truly-privateomdsh-web"></a>

