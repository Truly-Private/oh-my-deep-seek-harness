/**
 * Package-owned invariant companion for `@truly-private/omdsh-api-gateway`.
 * @module @truly-private/omdsh-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-api-gateway'
