/** Package-owned invariant companion for `@truly-private/omdsh-attachment`. @module @truly-private/omdsh-attachment/invariant */

/* jscpd:ignore-start */
import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@truly-private/omdsh-invariants'

const PACKAGE_NAME = '@truly-private/omdsh-attachment'
