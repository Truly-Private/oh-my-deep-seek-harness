/**
 * Package-owned invariant companion for `@truly-private/omdsh-app-boot`.
 * @module @truly-private/omdsh-app-boot/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-app-boot'
