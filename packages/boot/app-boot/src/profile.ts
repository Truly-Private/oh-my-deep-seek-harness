 ...
 * @module @truly-private/omdsh-app-boot/profile
 */
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@truly-private/omdsh-base', '@truly-private/omdsh-web-app'],
  headless: ['@truly-private/omdsh-base', '@truly-private/omdsh-headless'],
}

/** Installation-owned bundle tuples normalized to the shipped template. */
const INSTALLATION_OWNED_PROFILE_TUPLES: Record<string, readonly string[]> = {
  headless: ['@truly-private/omdsh-base', '@truly-private/omdsh-web-app', '@truly-private/omdsh-headless'],
}

/** The bundle list a `dsh plugin` init uses for a name with no shipped template. */
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@truly-private/omdsh-base']
 ...
 * `@truly-private/omdsh-base` (and every other in-box bundle) always comes from
