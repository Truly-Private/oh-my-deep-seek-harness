/**
 * @truly-private/omdsh-web-app — the browser-surface bundle's runtime glue plugin
 ...
 * @module @truly-private/omdsh-web-app
 */
...
import { addHarnessSourceSection } from '@truly-private/omdsh-app-boot'
import * as FrontendStatic from '@truly-private/omdsh-host-frontend-static'
...
function resolveDistIndex(): string {
  ...
  try {
    return require.resolve('@truly-private/omdsh-web-frontend/dist/index.html')
  } catch {
