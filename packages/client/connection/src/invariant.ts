/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-connection`.
 * @module @truly-private/omdsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-connection'
