/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-hmr`.
 * @module @truly-private/omdsh-client-hmr/invariant
 */

import type { Context, Fiber } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@truly-private/omdsh-invariants'

const PACKAGE_NAME = '@truly-private/omdsh-client-hmr'
