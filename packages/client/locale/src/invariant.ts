/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-locale`.
 * @module @truly-private/omdsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-locale'
