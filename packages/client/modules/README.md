...
- **No unload bookkeeping of its own** — style removal and fiber teardown ordering live with the HMR driver (`@truly-private/omdsh-client-hmr`); the loader only inventories owned style tag ids per record.
