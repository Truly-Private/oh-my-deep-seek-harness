/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-modules`.
 * @module @truly-private/omdsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-modules'
