...
import type { ConnectionHandle, SessionId } from '@truly-private/omdsh-api-remotes/client'
...
import type { TypertContext } from '@truly-private/omdsh-typert-protocol'
import type { MaybeSnapshotSelectorHook, SnapshotSelectorHook } from '@truly-private/omdsh-client-ui-slots'
...
export { isAppendSurfaceEvent, isReplacementSurfaceEvent } from '@truly-private/omdsh-session/surface'
...
export type { SubagentAddress, JobView } from '@truly-private/omdsh-client-connection/client'
...
export type { SessionId } from '@truly-private/omdsh-client-connection/client'
...
declare module '@truly-private/omdsh-client-ui-slots' {
  /**
