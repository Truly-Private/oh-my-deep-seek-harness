/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-runtime`.
 * @module @truly-private/omdsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@truly-private/omdsh-client-ui-slots'
import type { InvariantInstaller } from '@truly-private/omdsh-invariants'

const PACKAGE_NAME = '@truly-private/omdsh-client-runtime'
