/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-schema-form`.
 * @module @truly-private/omdsh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-schema-form'
