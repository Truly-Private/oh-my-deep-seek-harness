/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-agent-preset`.
 * @module @truly-private/omdsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-agent-preset'
