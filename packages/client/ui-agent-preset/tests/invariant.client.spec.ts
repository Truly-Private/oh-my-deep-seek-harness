...
import * as AgentPresetInvariant from '@truly-private/omdsh-client-ui-agent-preset/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@truly-private/omdsh-client-ui-agent-preset')
