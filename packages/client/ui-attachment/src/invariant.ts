/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-attachment`.
 * @module @truly-private/omdsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-attachment'
