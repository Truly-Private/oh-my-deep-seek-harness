...
} from '@truly-private/omdsh-client-ui-primitives'
import { AttachmentRail, DropOverlay, ImageLightbox } from '@truly-private/omdsh-client-ui-attachment'
import type { AttachmentRailItem } from '@truly-private/omdsh-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@truly-private/omdsh-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@truly-private/omdsh-goal/client'
...
import type { Translate } from '@truly-private/omdsh-client-ui-slots'
