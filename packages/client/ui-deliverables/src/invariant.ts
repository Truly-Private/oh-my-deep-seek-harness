/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-deliverables`.
 * @module @truly-private/omdsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-deliverables'
