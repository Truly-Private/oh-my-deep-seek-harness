...
import type { ChatFileMentions, TurnTailOwnerProps } from '@truly-private/omdsh-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@truly-private/omdsh-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@truly-private/omdsh-client-ui-deliverables'])
