/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-goal`.
 * @module @truly-private/omdsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-goal'
