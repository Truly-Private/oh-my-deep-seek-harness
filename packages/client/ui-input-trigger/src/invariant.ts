/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-input-trigger`.
 * @module @truly-private/omdsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-input-trigger'
