/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-jobs`.
 * @module @truly-private/omdsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-jobs'
