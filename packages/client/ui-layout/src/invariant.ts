/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-layout`.
 * @module @truly-private/omdsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-layout'
