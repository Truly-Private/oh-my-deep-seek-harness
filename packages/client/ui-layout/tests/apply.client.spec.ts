...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@truly-private/omdsh-client-ui-theme/client'
import { apply, inject, LayoutController } from '@truly-private/omdsh-client-ui-layout/client'
import { apply as nodeApply } from '@truly-private/omdsh-client-ui-layout'
import * as invariant from '@truly-private/omdsh-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@truly-private/omdsh-client-ui-layout', expect.any(Function))
