/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-message-feedback`.
 * @module @truly-private/omdsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-message-feedback'
