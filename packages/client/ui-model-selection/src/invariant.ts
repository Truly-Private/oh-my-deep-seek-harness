/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-model-selection`.
 * @module @truly-private/omdsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-model-selection'
