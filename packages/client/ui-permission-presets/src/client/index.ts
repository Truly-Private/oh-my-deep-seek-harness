 ...
 */
import type { ConnectionHandle } from '@truly-private/omdsh-api-remotes/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@truly-private/omdsh-client-locale/client'
// Type-only: the settings slot types (this package registers a General row).
import type {} from '@truly-private/omdsh-client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@truly-private/omdsh-api-remotes/client'
import type { ClientContext, SessionFace } from '@truly-private/omdsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@truly-private/omdsh-client-ui-commands/client'
import type { ClientSessionContext } from '@truly-private/omdsh-client-ui-input-trigger/client'
import type { PermissionSelect } from '@truly-private/omdsh-permission-presets/client'
