/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-plan`.
 * @module @truly-private/omdsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-plan'
