/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-settings-general`.
 * @module @truly-private/omdsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-settings-general'
