...
export const en = {
  ...
  onboardingTitle: 'Connect 9Router to get started',
  onboardingDescription: 'Paste the endpoint key from the 9Router dashboard. The local endpoint and starter model are already configured.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  onboardingTitle: '连接 9Router 开始使用',
  onboardingDescription: '粘贴 9Router 控制面板中的端点密钥。本地端点和入门模型已经配置完成。',
