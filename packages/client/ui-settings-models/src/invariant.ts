/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-settings-models`.
 * @module @truly-private/omdsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-settings-models'
