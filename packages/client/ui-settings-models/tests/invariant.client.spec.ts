...
import * as ModelsInvariant from '@truly-private/omdsh-client-ui-settings-models/invariant'
...
describe('invariant companion', () => {
  ...
  it('node-half apply is a no-op host placeholder', async () => {
    const { apply } = await import('@truly-private/omdsh-client-ui-settings-models')
    apply()
