/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-settings-plugins`.
 * @module @truly-private/omdsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-settings-plugins'
