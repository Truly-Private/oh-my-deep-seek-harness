...
import * as PluginConfigInvariant from '@truly-private/omdsh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@truly-private/omdsh-client-ui-settings-plugins')
