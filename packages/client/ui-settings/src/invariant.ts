/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-settings`.
 * @module @truly-private/omdsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-settings'
