 ...
 */
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@truly-private/omdsh-client-ui-slots'
// Type-only: pulls ui-layout's SlotMap merge (the 'sidebar' entry) into every
// program that sees this contract, so PropsRuntime<'sidebar'> resolves.
import type {} from '@truly-private/omdsh-client-ui-layout/client'
import type { WorkspaceId } from '@truly-private/omdsh-client-runtime/client'
