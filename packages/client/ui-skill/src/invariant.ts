/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-skill`.
 * @module @truly-private/omdsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-skill'
