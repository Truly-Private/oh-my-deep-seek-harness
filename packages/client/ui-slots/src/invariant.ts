/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-slots`.
 * @module @truly-private/omdsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-slots'
