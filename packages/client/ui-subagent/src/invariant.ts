/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-subagent`.
 * @module @truly-private/omdsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-subagent'
