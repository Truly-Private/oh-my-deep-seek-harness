/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-theme`.
 * @module @truly-private/omdsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-theme'
