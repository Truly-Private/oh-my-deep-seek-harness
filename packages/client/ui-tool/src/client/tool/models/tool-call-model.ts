...
import type { ToolCallBlock, ToolResultNode } from '@truly-private/omdsh-client-runtime/client'

export type { ToolCallBlock } from '@truly-private/omdsh-client-runtime/client'
