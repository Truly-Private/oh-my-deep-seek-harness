/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-tool`.
 * @module @truly-private/omdsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-tool'
