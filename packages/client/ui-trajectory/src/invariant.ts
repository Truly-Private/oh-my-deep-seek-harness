/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-trajectory`.
 * @module @truly-private/omdsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-trajectory'
