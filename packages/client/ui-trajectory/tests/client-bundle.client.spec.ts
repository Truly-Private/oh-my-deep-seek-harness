 ...
 * not built (`pnpm --filter @truly-private/omdsh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@truly-private/omdsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@truly-private/omdsh-client-runtime/client', await import('@truly-private/omdsh-client-runtime/client')],
      ['@truly-private/omdsh-client-ui-primitives', await import('@truly-private/omdsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@truly-private/omdsh-client-locale/client')
