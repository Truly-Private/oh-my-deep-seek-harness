/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-user-questions`.
 * @module @truly-private/omdsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-user-questions'
