/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-workspace`.
 * @module @truly-private/omdsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-workspace'
