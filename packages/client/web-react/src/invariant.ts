/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-web-react`.
 * @module @truly-private/omdsh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-web-react'
