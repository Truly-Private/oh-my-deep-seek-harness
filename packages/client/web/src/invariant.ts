/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-web`.
 * @module @truly-private/omdsh-client-web/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-web'
