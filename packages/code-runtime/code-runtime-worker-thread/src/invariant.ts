/**
 * Package-owned invariant companion for `@truly-private/omdsh-code-runtime-worker-thread`.
 * @module @truly-private/omdsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-code-runtime-worker-thread'
