/** JSON string-prefix accounting for the outer-output ledger. @module @truly-private/omdsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@truly-private/omdsh-code-runtime'
