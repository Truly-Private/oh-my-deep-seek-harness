...
import * as invariant from '@truly-private/omdsh-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@truly-private/omdsh-command-compact', expect.any(Function))
    expect(() => {
