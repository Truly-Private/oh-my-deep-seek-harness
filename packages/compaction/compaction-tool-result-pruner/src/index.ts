 ...
 *
 * @module @truly-private/omdsh-compaction-tool-result-pruner
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { freezeMessage } from '@truly-private/omdsh-llm'
import type { ContentBlock } from '@truly-private/omdsh-llm'
import type { Session, SessionEvent, ToolResultMessage } from '@truly-private/omdsh-session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from '@truly-private/omdsh-compaction'
