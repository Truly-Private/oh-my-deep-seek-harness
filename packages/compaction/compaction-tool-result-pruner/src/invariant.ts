/**
 * Package-owned invariant companion for `@truly-private/omdsh-compaction-tool-result-pruner`.
 * @module @truly-private/omdsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-compaction-tool-result-pruner'
