 ...
 *
 * The seam itself lives in `@truly-private/omdsh-compaction`, which re-exports these
 ...
 *
 * @module @truly-private/omdsh-compaction/checkpoint
 */

import type { MessageSource } from '@truly-private/omdsh-llm/message'
