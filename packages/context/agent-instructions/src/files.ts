 ...
 *
 * @module @truly-private/omdsh-agent-instructions/files
 */

import { createReadStream } from 'node:fs'
import { stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, relative, resolve } from 'node:path'
import type { FileSystem, FsInfo, FsTarget, FsVersion } from '@truly-private/omdsh-fs'
import { assertNever } from '@truly-private/omdsh-llm'
import { dshHomeDisplay } from '@truly-private/omdsh-home-paths'
