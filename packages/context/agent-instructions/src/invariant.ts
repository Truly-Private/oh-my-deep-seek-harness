/**
 * Package-owned invariant companion for `@truly-private/omdsh-agent-instructions`.
 * @module @truly-private/omdsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-agent-instructions'
