/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-reference`.
 * @module @truly-private/omdsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-reference'
