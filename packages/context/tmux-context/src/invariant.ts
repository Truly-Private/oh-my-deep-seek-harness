/**
 * Package-owned invariant companion for `@truly-private/omdsh-tmux-context`.
 * @module @truly-private/omdsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tmux-context'
