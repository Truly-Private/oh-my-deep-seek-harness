 ...
 * @module @truly-private/omdsh-agent-loop/runtime-context
 */

import { createUserMessage } from '@truly-private/omdsh-llm'
import type { ContextSnapshotSection } from '@truly-private/omdsh-llm'
import type { Session, UserMessage } from '@truly-private/omdsh-session'
import { isReplacementSurfaceEvent } from '@truly-private/omdsh-session'
import type { Context } from '@deepseek-ai/cordis'

const SOURCE = '@truly-private/omdsh-system-prompt'
