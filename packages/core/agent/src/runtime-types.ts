 ...
 * turn/step boundaries remain `@truly-private/omdsh-session` events.
 *
 * @module @truly-private/omdsh-agent
 */

import type { Context } from '@deepseek-ai/cordis'
import type { Scoped } from '@truly-private/omdsh-scope'
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@truly-private/omdsh-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@truly-private/omdsh-session'
export type { AgentCancelCause } from '@truly-private/omdsh-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@truly-private/omdsh-system-prompt'
declare module '@truly-private/omdsh-system-prompt' {
...
declare module '@deepseek-ai/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@truly-private/omdsh-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
