/** Package-owned scoped-dispatch invariants. @module @truly-private/omdsh-scope/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@truly-private/omdsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@truly-private/omdsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@truly-private/omdsh-scope'
