 ...
 *
 * @module @truly-private/omdsh-session
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@truly-private/omdsh-llm'
import { scopeOf, scopeTarget } from '@truly-private/omdsh-scope'
import type { Scoped } from '@truly-private/omdsh-scope'
import type { Message } from '@truly-private/omdsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@truly-private/omdsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@truly-private/omdsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@truly-private/omdsh-session#Session',
        wireTypeSymbol: '@truly-private/omdsh-session/types#SessionId',
