 ...
 * companion beside `@truly-private/omdsh-invariants` to enable the checks.
 *
 * @module @truly-private/omdsh-session/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import { assertNever } from '@truly-private/omdsh-llm'
import type { CallId } from '@truly-private/omdsh-llm'
import type { InvariantFailure, InvariantInstaller } from '@truly-private/omdsh-invariants'
import type { Session, SessionEvent } from '@truly-private/omdsh-session'
import { TOOL_NOT_STARTED } from './repair.ts'

const PACKAGE_NAME = '@truly-private/omdsh-session'
