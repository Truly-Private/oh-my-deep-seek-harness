 ...
 *
 * @module @truly-private/omdsh-system-prompt
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@truly-private/omdsh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@truly-private/omdsh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@truly-private/omdsh-llm'
...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@truly-private/omdsh-scope`): scoped listeners
