/**
 * Package-owned invariant companion for `@truly-private/omdsh-credentials-local`.
 * @module @truly-private/omdsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-credentials-local'
