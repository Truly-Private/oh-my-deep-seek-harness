/**
 * Package-owned invariant companion for `@truly-private/omdsh-credentials`.
 * @module @truly-private/omdsh-credentials/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantFailure, InvariantInstaller } from '@truly-private/omdsh-invariants'

const PACKAGE_NAME = '@truly-private/omdsh-credentials'
