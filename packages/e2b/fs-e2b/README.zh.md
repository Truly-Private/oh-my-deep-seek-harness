...
[`@truly-private/omdsh-fs`](../../fs/fs/README.md) 提供方约定的 E2B 实现。它没有配置：先加载 [`@truly-private/omdsh-e2b`](../e2b/README.md)，再用本服务取代 `dsh-fs-local`。该提供方使用所有者的远程 cwd 和 SDK 句柄，因此文件工具观察到的环境与 E2B 后端 Bash 进程相同。
