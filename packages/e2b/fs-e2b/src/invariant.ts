/**
 * Package-owned invariant companion for `@truly-private/omdsh-fs-e2b`.
 * @module @truly-private/omdsh-fs-e2b/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-fs-e2b'
