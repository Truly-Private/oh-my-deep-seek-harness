...
[`@truly-private/omdsh-subprocess`](../../subprocess/subprocess/README.md) seam 的 E2B 实现。先加载 [`@truly-private/omdsh-e2b`](../e2b/README.md)，再用本服务取代 `dsh-subprocess-local`。现有的 Bash、PTY 和 LSP 消费方随后会在共享远程沙箱中执行，无需 E2B 专用的能力包。
