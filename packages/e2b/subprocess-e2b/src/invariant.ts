/**
 * Package-owned invariant companion for `@truly-private/omdsh-subprocess-e2b`.
 * @module @truly-private/omdsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-subprocess-e2b'
