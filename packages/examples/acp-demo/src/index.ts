 ...
 * ({@link @truly-private/omdsh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @truly-private/omdsh-acp} bridge. The app owns those plugins through one
 ...
 * @module @truly-private/omdsh-acp-demo
 */

import type { Context } from '@deepseek-ai/cordis'
import { join } from 'node:path'
import z from '@deepseek-ai/schemastery'
import * as acp from '@truly-private/omdsh-acp'
import * as agentCore from '@truly-private/omdsh-agent-spine-demo'
...
} from '@truly-private/omdsh-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@truly-private/omdsh-session-checkpoint-policy'
