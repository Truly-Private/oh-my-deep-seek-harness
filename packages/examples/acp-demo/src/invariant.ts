/**
 * Package-owned invariant companion for `@truly-private/omdsh-acp-demo`.
 * @module @truly-private/omdsh-acp-demo/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-acp-demo'
