 ...
 * @module @truly-private/omdsh-agent-spine-demo
 */
...
import SessionTitleService, { type Config as SessionTitleConfig } from '@truly-private/omdsh-session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@truly-private/omdsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@truly-private/omdsh-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@truly-private/omdsh-skill'
import * as SkillFileSystem from '@truly-private/omdsh-skill-filesystem'
import AgentRegistry from '@truly-private/omdsh-agent'
import GoalService, { type Config as GoalDomainConfig } from '@truly-private/omdsh-goal'
import * as goalSession from '@truly-private/omdsh-goal-round-driver'
import * as toolGoal from '@truly-private/omdsh-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@truly-private/omdsh-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@truly-private/omdsh-invariants'
import * as sessionInvariant from '@truly-private/omdsh-session/invariant'
import * as agentInvariant from '@truly-private/omdsh-agent/invariant'
import * as scopeInvariant from '@truly-private/omdsh-scope/invariant'
import * as agentLoopInvariant from '@truly-private/omdsh-agent-loop/invariant'
import * as toolBash from '@truly-private/omdsh-tool-bash'
import * as bashEnv from '@truly-private/omdsh-shell-env'
import * as workspaceContext from '@truly-private/omdsh-agent-instructions'
import * as toolSkill from '@truly-private/omdsh-tool-skill'
import * as toolJobs from '@truly-private/omdsh-tool-jobs'
import AgentLoop, { type Config as AgentLoopConfig } from '@truly-private/omdsh-agent-loop'
import * as llmRetry from '@truly-private/omdsh-llm-retry'
