/**
 * Package-owned invariant companion for `@truly-private/omdsh-sdk-jsonrpc-demo`.
 * @module @truly-private/omdsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-sdk-jsonrpc-demo'
