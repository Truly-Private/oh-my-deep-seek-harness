/**
 * Package-owned invariant companion for `@truly-private/omdsh-cordis-client-runner`.
 * @module @truly-private/omdsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-cordis-client-runner'
