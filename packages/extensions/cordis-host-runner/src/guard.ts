 ...
 * @module @truly-private/omdsh-cordis-host-runner/guard
 */

import { Context } from '@deepseek-ai/cordis'
import type { Plugin } from '@deepseek-ai/cordis'
import { scopeOf } from '@truly-private/omdsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@truly-private/omdsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@truly-private/omdsh-cordis-client-runner`, whose CTX_VERBS names this one its
