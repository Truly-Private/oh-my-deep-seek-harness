/**
 * Package-owned invariant companion for `@truly-private/omdsh-cordis-host-runner`.
 * @module @truly-private/omdsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-cordis-host-runner'
