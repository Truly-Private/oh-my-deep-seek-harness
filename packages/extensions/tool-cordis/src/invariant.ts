/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-cordis`.
 * @module @truly-private/omdsh-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-cordis'
