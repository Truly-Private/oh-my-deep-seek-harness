/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-cordis`.
 * @module @truly-private/omdsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-cordis'
