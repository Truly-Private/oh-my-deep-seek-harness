/**
 * Package-owned invariant companion for `@truly-private/omdsh-command-feedback`.
 * @module @truly-private/omdsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-command-feedback'
