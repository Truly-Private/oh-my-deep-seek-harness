...
import type { Agent, AgentStatus } from '@truly-private/omdsh-agent'
import CommandRuntime from '@truly-private/omdsh-commands'
import SessionStore, { foldSurface, Session, SessionId } from '@truly-private/omdsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@truly-private/omdsh-session-telemetry'
import * as commandFeedback from '@truly-private/omdsh-command-feedback'
...
vi.mock('@truly-private/omdsh-anonymous-user-id', () => ({
...
describe('@truly-private/omdsh-command-feedback registration', () => {
