...
describe('/feedback real Loader composition through cordis.yml', () => {
  it('boots cordis.yml and records feedback without model-visible output', async () => {
    ...
    await writeFile(configPath, [
      ...
      "- name: '@truly-private/omdsh-commands'",
      "- name: '@truly-private/omdsh-command-feedback'",
      '',
    ].join('\n'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@truly-private/omdsh-commands', CommandRuntime],
      ['@truly-private/omdsh-command-feedback', CommandFeedback],
    ])
