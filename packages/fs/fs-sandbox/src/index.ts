 ...
 * `@truly-private/omdsh-fs` Service Definition. It extends `LocalFileSystem` so all
 ...
 * stays `ctx.shell`'s job (`@truly-private/omdsh-bash-sandbox`). This mirrors the
 ...
 * escalation retry lives in the tool layer (`@truly-private/omdsh-tool-fs`),
 * exactly as bash's does.
 *
 * @module @truly-private/omdsh-fs-sandbox
 */

import { Context } from '@deepseek-ai/cordis'
import { LocalFileSystem } from '@truly-private/omdsh-fs-local'
import type { Config as LocalConfig } from '@truly-private/omdsh-fs-local'
import { FsError } from '@truly-private/omdsh-fs'
import type { FsEditOutcome, FsEditRequest, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@truly-private/omdsh-fs'
import { writableRoots } from '@truly-private/omdsh-sandbox'
