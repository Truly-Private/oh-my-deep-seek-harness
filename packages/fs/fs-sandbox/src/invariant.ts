/**
 * Package-owned invariant companion for `@truly-private/omdsh-fs-sandbox`.
 * @module @truly-private/omdsh-fs-sandbox/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-fs-sandbox'
