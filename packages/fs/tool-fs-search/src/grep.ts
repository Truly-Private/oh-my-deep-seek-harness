 ...
 *
 * @module @truly-private/omdsh-tool-fs-search/grep
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@truly-private/omdsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@truly-private/omdsh-tools'
import type { RetainedItems } from '@truly-private/omdsh-output-retention'
import type { SpillRef } from '@truly-private/omdsh-spill'
