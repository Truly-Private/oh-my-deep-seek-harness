/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-fs-search`.
 * @module @truly-private/omdsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-fs-search'
