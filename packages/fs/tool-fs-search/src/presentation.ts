 ...
 * model-facing render consumes ({@link module:@truly-private/omdsh-tool-fs-search/search-core}
 ...
 *
 * @module @truly-private/omdsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@truly-private/omdsh-tool-fs-search/grep} `formatGrepMatches`), so
