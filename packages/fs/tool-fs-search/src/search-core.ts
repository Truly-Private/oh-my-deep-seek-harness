 ...
 *
 * @module @truly-private/omdsh-tool-fs-search/search-core
 */

import { isAbsolute, relative, sep } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import { HarnessError } from '@truly-private/omdsh-llm'
import { ItemRetainer, TextRetainer } from '@truly-private/omdsh-output-retention'
import type { RetainedItems } from '@truly-private/omdsh-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@truly-private/omdsh-subprocess'
import type { SaveTextSpill, SpillRef } from '@truly-private/omdsh-spill'
 ...
 * `@truly-private/omdsh-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@truly-private/omdsh-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@truly-private/omdsh-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@truly-private/omdsh-tool-fs-search/presentation} `grepSearchMeta`)
