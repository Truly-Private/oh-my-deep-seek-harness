/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-fs`.
 * @module @truly-private/omdsh-tool-fs/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-fs'
