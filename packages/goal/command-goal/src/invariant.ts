/**
 * Package-owned invariant companion for `@truly-private/omdsh-command-goal`.
 * @module @truly-private/omdsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-command-goal'
