...
import * as GoalSessionInvariant from '@truly-private/omdsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@truly-private/omdsh-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@truly-private/omdsh-invariants'
import SessionStore, { SessionId, type Session } from '@truly-private/omdsh-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@truly-private/omdsh-goal-round-driver',
    }))
  })
