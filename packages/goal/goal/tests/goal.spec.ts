...
import AgentRegistry, { agentEvents, Inbox } from '@truly-private/omdsh-agent'
import type { Agent } from '@truly-private/omdsh-agent'
import { createUserMessage, HarnessError } from '@truly-private/omdsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@truly-private/omdsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@truly-private/omdsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@truly-private/omdsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@truly-private/omdsh-session').SessionEvent[]): StubAgent {
