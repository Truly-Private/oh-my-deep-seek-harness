/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-goal`.
 * @module @truly-private/omdsh-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-goal'
