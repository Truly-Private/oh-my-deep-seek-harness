/**
 * Package-owned invariant companion for `@truly-private/omdsh-repeat-tool-reminder`.
 * @module @truly-private/omdsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-repeat-tool-reminder'
