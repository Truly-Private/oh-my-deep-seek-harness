/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-call-timeout-policy`.
 * @module @truly-private/omdsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-call-timeout-policy'
