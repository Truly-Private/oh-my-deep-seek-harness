/**
 * Unit + real-load-path coverage for @truly-private/omdsh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@truly-private/omdsh-llm'
import SystemPrompt from '@truly-private/omdsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@truly-private/omdsh-tools'
import * as timeoutPolicy from '@truly-private/omdsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@truly-private/omdsh-tool-call-timeout-policy'
