...
The **shared core** of the Claude Code / Codex hook wire protocol. NOT a cordis plugin — it registers nothing and injects nothing. It is a **library** of dialect-neutral primitives the two bridge plugins (`@truly-private/omdsh-hooks-claude-code`, `@truly-private/omdsh-hooks-codex`) import so neither re-implements the identical halves of the protocol.
