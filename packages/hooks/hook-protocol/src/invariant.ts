/** Package-owned hook invocation/result stream invariants. @module @truly-private/omdsh-hook-protocol/invariant */
...
const PACKAGE_NAME = '@truly-private/omdsh-hook-protocol'
