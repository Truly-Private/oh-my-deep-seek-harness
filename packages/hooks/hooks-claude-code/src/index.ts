 ...
 * @module @truly-private/omdsh-hooks-claude-code
 */
...
import type { UserMessage } from '@truly-private/omdsh-session'
import type {} from '@truly-private/omdsh-session-persistence'
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@truly-private/omdsh-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
...
} from '@truly-private/omdsh-hook-protocol'
// Pulls in the declaration-merged subagent events and the identity pairing their
// start/end edges.
import type { SubagentRunId } from '@truly-private/omdsh-subagent'
