/**
 * Package-owned invariant companion for `@truly-private/omdsh-hooks-claude-code`.
 * @module @truly-private/omdsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-hooks-claude-code'
