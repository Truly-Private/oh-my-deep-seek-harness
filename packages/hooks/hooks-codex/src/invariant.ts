/**
 * Package-owned invariant companion for `@truly-private/omdsh-hooks-codex`.
 * @module @truly-private/omdsh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-hooks-codex'
