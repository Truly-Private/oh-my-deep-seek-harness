...
import type { AskUserQuestionItem } from '@truly-private/omdsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@truly-private/omdsh-user-approval/types'
import type { Message } from '@truly-private/omdsh-llm/types'
import type { MessageId } from '@truly-private/omdsh-llm/brand'
import type { CallId } from '@truly-private/omdsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@truly-private/omdsh-session/types'
import type { ToolCallView, ToolResultView } from '@truly-private/omdsh-tools/presentation'
...
export type { ToolCallView, ToolResultView } from '@truly-private/omdsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@truly-private/omdsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
