...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@truly-private/omdsh-attachment'
import type { ContentBlock } from '@truly-private/omdsh-llm/types'
import type { SessionEvent, SessionId } from '@truly-private/omdsh-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@truly-private/omdsh-session-projection/types'
...
declare module '@truly-private/omdsh-llm' {
