/**
 * Package-owned invariant companion for `@truly-private/omdsh-host-apiproxy`.
 * @module @truly-private/omdsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-host-apiproxy'
