...
import type { Agent, AgentFactory } from '@truly-private/omdsh-agent'
...
import type { DirectoryPickerCapability } from '@truly-private/omdsh-host-directory-picker'
import WorkspaceRegistry from '@truly-private/omdsh-workspace'
import type { HostFrame, WorkspaceId } from '@truly-private/omdsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@truly-private/omdsh-host-apiproxy/api/rpc'
