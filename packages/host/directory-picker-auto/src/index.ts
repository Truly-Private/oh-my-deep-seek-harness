 ...
 * @module @truly-private/omdsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@truly-private/omdsh-host-directory-picker-native',
  browse: '@truly-private/omdsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@truly-private/omdsh-client-ui-directory-picker-native',
  browse: '@truly-private/omdsh-client-ui-directory-picker-browse',
}
