...
import HttpServer from '@truly-private/omdsh-host-webserver'
import type { DirectoryPicker } from '@truly-private/omdsh-host-directory-picker'
import BrowseDirectoryPicker from '@truly-private/omdsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@truly-private/omdsh-host-directory-picker-native'
...
const AUTO = '@truly-private/omdsh-host-directory-picker-auto'
const NATIVE = '@truly-private/omdsh-host-directory-picker-native'
const BROWSE = '@truly-private/omdsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@truly-private/omdsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@truly-private/omdsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@truly-private/omdsh-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@truly-private/omdsh-host-webserver', HttpServer],
