/** Package-owned invariant companion for the directory-picker seam. @module @truly-private/omdsh-host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@truly-private/omdsh-invariants'

const PACKAGE_NAME = '@truly-private/omdsh-host-directory-picker'
