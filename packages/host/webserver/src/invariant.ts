/**
 * Package-owned invariant companion for `@truly-private/omdsh-host-webserver`.
 * @module @truly-private/omdsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-host-webserver'
