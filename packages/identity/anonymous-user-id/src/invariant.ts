/**
 * Package-owned invariant companion for `@truly-private/omdsh-anonymous-user-id`.
 * @module @truly-private/omdsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-anonymous-user-id'
