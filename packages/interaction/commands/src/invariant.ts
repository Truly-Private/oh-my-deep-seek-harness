/**
 * Package-owned invariant companion for `@truly-private/omdsh-commands`:
 * command lifecycle events pair by commandId within one session log.
 * @module @truly-private/omdsh-commands/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-commands'
