...
import * as CommandInvariant from '@truly-private/omdsh-commands/invariant'
...
import { CommandId } from '@truly-private/omdsh-commands'
...
describe('command lifecycle invariants', () => {
  ...
  it.each([-1, 1.5, 1])('rejects invalid or non-prior sourceEventSeq %s', async (sourceEventSeq) => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@truly-private/omdsh-commands',
    }))
  })
