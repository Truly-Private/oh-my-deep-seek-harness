/** Package-owned permission-preset event invariants. @module @truly-private/omdsh-permission-presets/invariant */
...
const PACKAGE_NAME = '@truly-private/omdsh-permission-presets'
