...
The model sees the generated [`ask_user_question` schema](../../../docs/tool-catalog.md#truly-privateomdsh-tool-ask-user), including question ids, prompts, headings, options, and multi-select flags.
