/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-ask-user`.
 * @module @truly-private/omdsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-ask-user'
