/**
 * Package-owned invariant companion for `@truly-private/omdsh-user-questions`.
 * @module @truly-private/omdsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-user-questions'
