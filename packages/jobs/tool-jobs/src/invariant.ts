/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-jobs`.
 * @module @truly-private/omdsh-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-jobs'
