/** Package-owned durable retry-event invariants. @module @truly-private/omdsh-llm-retry/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { Session, SessionEvent } from '@truly-private/omdsh-session'
import type { LlmFailure } from '@truly-private/omdsh-llm'
...
const PACKAGE_NAME = '@truly-private/omdsh-llm-retry'
