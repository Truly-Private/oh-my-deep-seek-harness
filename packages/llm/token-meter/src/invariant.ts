/**
 * Package-owned invariant companion for `@truly-private/omdsh-token-meter`.
 * @module @truly-private/omdsh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-token-meter'
