/**
 * Package-owned invariant companion for `@truly-private/omdsh-lsp-stdio`.
 * @module @truly-private/omdsh-lsp-stdio/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-lsp-stdio'
