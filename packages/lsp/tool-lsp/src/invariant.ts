/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-lsp`.
 * @module @truly-private/omdsh-tool-lsp/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-lsp'
