/**
 * Package-owned invariant companion for `@truly-private/omdsh-mcp-client`.
 * @module @truly-private/omdsh-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-mcp-client'
