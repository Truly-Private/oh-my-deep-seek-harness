 ...
 * @module @truly-private/omdsh-agent-presets/authoring
 */

import { chmod, cp, readdir, readFile, rm, stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, resolve } from 'node:path'
import { writeFileAtomic } from '@truly-private/omdsh-atomic-write'
import { expandHomePath } from '@truly-private/omdsh-home-paths'
