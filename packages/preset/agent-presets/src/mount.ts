 ...
 * @module @truly-private/omdsh-agent-presets/mount
 */
...
import { scopeOf, scopeParentOf, type ScopeKey } from '@truly-private/omdsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@truly-private/omdsh-*` row would fail to import. The
