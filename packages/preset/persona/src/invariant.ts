/**
 * Package-owned invariant companion for `@truly-private/omdsh-persona`.
 * @module @truly-private/omdsh-persona/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-persona'
