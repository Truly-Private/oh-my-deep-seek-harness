/**
 * Package-owned invariant companion for `@truly-private/omdsh-invariants`.
 * @module @truly-private/omdsh-invariants/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-invariants'
