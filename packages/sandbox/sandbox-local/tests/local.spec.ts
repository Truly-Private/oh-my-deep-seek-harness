...
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@truly-private/omdsh-sandbox'
import type { SandboxPolicy } from '@truly-private/omdsh-sandbox'
import {
  LocalSandboxProvider,
} from '@truly-private/omdsh-sandbox-local'
import type { Config } from '@truly-private/omdsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @truly-private/omdsh-sandbox-windows-acl/tests/provider-chain.spec.ts
