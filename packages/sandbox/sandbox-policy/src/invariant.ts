/** Package-owned session-event invariants for sandbox policy. @module @truly-private/omdsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@truly-private/omdsh-sandbox-policy'
