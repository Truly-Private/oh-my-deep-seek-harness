/**
 * Package-owned invariant companion for `@truly-private/omdsh-sandbox-windows-acl`.
 * @module @truly-private/omdsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-sandbox-windows-acl'
