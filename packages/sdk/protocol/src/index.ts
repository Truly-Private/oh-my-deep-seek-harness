 ...
 * (`@truly-private/omdsh-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@truly-private/omdsh-sdk-client`, the Python SDK) drive it.
 *
 * @module @truly-private/omdsh-sdk-protocol
 */
