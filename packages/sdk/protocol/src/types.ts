 ...
 * plugin (`@truly-private/omdsh-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `deepseek-harness-sdk-runtime`.
 *
 * @module @truly-private/omdsh-sdk-protocol/types
 */

import type { ContentBlock } from '@truly-private/omdsh-llm'
import type { SessionEvent } from '@truly-private/omdsh-session'
import type { SubagentStopReason } from '@truly-private/omdsh-subagent'
