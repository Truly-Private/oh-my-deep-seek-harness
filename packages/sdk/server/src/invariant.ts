/**
 * Package-owned invariant companion for `@truly-private/omdsh-sdk-jsonrpc-server`.
 * @module @truly-private/omdsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-sdk-jsonrpc-server'
