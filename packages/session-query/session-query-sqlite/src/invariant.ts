/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-query-sqlite`.
 * @module @truly-private/omdsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-query-sqlite'
