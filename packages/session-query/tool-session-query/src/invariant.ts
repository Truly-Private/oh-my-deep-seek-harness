/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-session-query`.
 * @module @truly-private/omdsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-session-query'
