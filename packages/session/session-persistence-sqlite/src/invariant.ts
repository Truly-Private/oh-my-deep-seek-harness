/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-persistence-sqlite`.
 * @module @truly-private/omdsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-persistence-sqlite'
