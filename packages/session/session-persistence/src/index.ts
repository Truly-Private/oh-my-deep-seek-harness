 ...
 * @module @truly-private/omdsh-session-persistence
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { SessionPreparation } from '@truly-private/omdsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@truly-private/omdsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@truly-private/omdsh-session'
