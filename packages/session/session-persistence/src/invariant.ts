/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-persistence`.
 * @module @truly-private/omdsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-persistence'
