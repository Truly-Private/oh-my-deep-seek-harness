/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-projection-cache`.
 * @module @truly-private/omdsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-projection-cache'
