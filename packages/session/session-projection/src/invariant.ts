/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-projection`.
 * @module @truly-private/omdsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-projection'
