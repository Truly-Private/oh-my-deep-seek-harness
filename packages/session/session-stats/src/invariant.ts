/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-stats`.
 * @module @truly-private/omdsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-stats'
