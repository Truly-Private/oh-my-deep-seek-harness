 ...
 *
 * @module @truly-private/omdsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@deepseek-ai/schemastery'
import type { Context } from '@deepseek-ai/cordis'
import type {} from '@truly-private/omdsh-command-feedback'
import {
...
} from '@truly-private/omdsh-session-telemetry'
import { APP_IDENTITY } from '@truly-private/omdsh-llm'
import { getOrCreateAnonymousUserId } from '@truly-private/omdsh-anonymous-user-id'
import {
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@truly-private/omdsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@truly-private/omdsh-session-telemetry-otel/ops', version)
