/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-telemetry`.
 * @module @truly-private/omdsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-telemetry'
