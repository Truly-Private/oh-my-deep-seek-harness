/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-title-first-prompt-llm`.
 * @module @truly-private/omdsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-title-first-prompt-llm'
