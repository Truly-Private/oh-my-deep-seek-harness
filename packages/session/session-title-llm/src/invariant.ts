/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-title-llm`.
 * @module @truly-private/omdsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-title-llm'
