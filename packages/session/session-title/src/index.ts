 ...
 * @module @truly-private/omdsh-session-title
 */
...
import { assertNever, deepFreeze, isAgentLoopRequest } from '@truly-private/omdsh-llm'
import type { GenerateOptions } from '@truly-private/omdsh-llm'
import type {
  Session,
  SessionEvent,
