/**
 * Package-owned invariant companion for `@truly-private/omdsh-session-title`.
 * @module @truly-private/omdsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-session-title'
