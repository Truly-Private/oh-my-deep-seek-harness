/**
 * Package-owned invariant companion for `@truly-private/omdsh-settings`.
 * @module @truly-private/omdsh-settings/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-settings'
