...
import { bwrapProfileArgs } from '@truly-private/omdsh-sandbox-local/src/profiles.ts'
 ...
 * backend-only confinement is covered by `@truly-private/omdsh-sandbox-local`.
 *
