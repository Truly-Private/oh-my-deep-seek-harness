 ...
 *
 * @module @truly-private/omdsh-pwsh-local
 */
...
import { SHELL_SETTINGS_NAMESPACE, ShellExecutor } from '@truly-private/omdsh-shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@truly-private/omdsh-shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@truly-private/omdsh-subprocess'
import { installSettingsSection } from '@truly-private/omdsh-settings'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@truly-private/omdsh-timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@truly-private/omdsh-pwsh-sandbox`.
