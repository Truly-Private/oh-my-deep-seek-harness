/**
 * Real-process tests for `@truly-private/omdsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@truly-private/omdsh-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@truly-private/omdsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@truly-private/omdsh-timeout'
import type { ShellProcess } from '@truly-private/omdsh-shell'
