...
- **Reads are unrestricted** on Windows (the ACL runner restricts writes only); the read boundary is documented in `@truly-private/omdsh-sandbox-windows-acl`.
