 ...
 * mirror of `@truly-private/omdsh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @truly-private/omdsh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@truly-private/omdsh-shell'
import type { RunnerFailureRule } from '@truly-private/omdsh-sandbox'
