 ...
 * `@truly-private/omdsh-bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * renders.
 * @module @truly-private/omdsh-pwsh-sandbox
 */

import { Context } from '@deepseek-ai/cordis'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellRunResult } from '@truly-private/omdsh-shell'
import { SandboxUnavailableError } from '@truly-private/omdsh-sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
