/**
 * Package-owned invariant companion for `@truly-private/omdsh-pwsh-sandbox`.
 * @module @truly-private/omdsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-pwsh-sandbox'
