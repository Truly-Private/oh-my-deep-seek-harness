/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-bash-persistent`.
 * @module @truly-private/omdsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-bash-persistent'
