/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-bash`.
 * @module @truly-private/omdsh-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-bash'
