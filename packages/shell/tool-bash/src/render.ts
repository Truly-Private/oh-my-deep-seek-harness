 ...
 *
 * @module @truly-private/omdsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@truly-private/omdsh-shell'
import type { SandboxMode } from '@truly-private/omdsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@truly-private/omdsh-sandbox'
 ...
 * rendering story, owned by `@truly-private/omdsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@truly-private/omdsh-shell'
