...
The model sees the generated [`pwsh` schema](../../../docs/tool-catalog.md#truly-privateomdsh-tool-pwsh). Agent-scoped tool restrictions can remove the definition for that agent.
