 ...
 * `@truly-private/omdsh-pwsh-local`) backs `ctx.shell`; the tool contract is
 ...
 * exit-status parse from `@truly-private/omdsh-shell`.
 *
 * @module @truly-private/omdsh-tool-pwsh
 */

import { isAbsolute, resolve as resolvePath } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { defineTool, TOOL_ABORTED } from '@truly-private/omdsh-tools'
import type { GenericCallView, TerminalCallView, ToolExecution, ToolResult, ToolResultView } from '@truly-private/omdsh-tools'
...
import type {} from '@truly-private/omdsh-shell-env'
...
import { ESCALATION_TARGETS, approveEscalation, validateEscalationArgs } from '@truly-private/omdsh-sandbox'
import type { SandboxPolicyService } from '@truly-private/omdsh-sandbox-policy'
import type { ShellRunResult } from '@truly-private/omdsh-shell'
import { parseExitStatus } from '@truly-private/omdsh-shell'
import { processOutcome } from './background.ts'
import { renderPwshProcessRead, renderPwshResult } from './render.ts'
import type { RenderablePwshResult } from './render.ts'

declare module '@truly-private/omdsh-jobs' {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: PwshToolArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) {
          throw new Error('background jobs unavailable: load @truly-private/omdsh-jobs and @truly-private/omdsh-tool-jobs')
        }
