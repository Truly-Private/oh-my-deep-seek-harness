 ...
 * Concrete
 * providers such as `@truly-private/omdsh-skill-filesystem` decide where skills come
 ...
 *
 * @module @truly-private/omdsh-skill
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { assertNever } from '@truly-private/omdsh-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@truly-private/omdsh-scope'
