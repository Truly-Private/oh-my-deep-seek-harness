/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-skill`.
 * @module @truly-private/omdsh-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-skill'
