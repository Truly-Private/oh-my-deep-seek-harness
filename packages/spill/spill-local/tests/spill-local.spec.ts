...
import type { SaveTextSpill } from '@truly-private/omdsh-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@truly-private/omdsh-spill-local'
