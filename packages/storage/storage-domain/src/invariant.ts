/**
 * Package-owned invariant companion for `@truly-private/omdsh-storage-domain`: every
 ...
 * @module @truly-private/omdsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-storage-domain'
