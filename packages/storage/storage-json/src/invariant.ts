/**
 * Package-owned invariant companion for `@truly-private/omdsh-storage-json`.
 * @module @truly-private/omdsh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-storage-json'
