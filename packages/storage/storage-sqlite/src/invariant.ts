/**
 * Package-owned invariant companion for `@truly-private/omdsh-storage-sqlite`.
 * @module @truly-private/omdsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-storage-sqlite'
