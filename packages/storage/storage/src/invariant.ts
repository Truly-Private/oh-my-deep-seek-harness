/**
 * Package-owned invariant companion for `@truly-private/omdsh-storage`.
 * @module @truly-private/omdsh-storage/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-storage'
