/**
 * Package-owned invariant companion for `@truly-private/omdsh-subagent-codex`.
 * @module @truly-private/omdsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-subagent-codex'
