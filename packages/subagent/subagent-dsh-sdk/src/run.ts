 ...
 * runtime over stdio JSON-RPC through `@truly-private/omdsh-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@truly-private/omdsh-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @truly-private/omdsh-subagent-dsh-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { DeepSeekHarness, type HarnessNotification } from '@truly-private/omdsh-sdk-client'
import type { ContentBlock } from '@truly-private/omdsh-llm'
import { SessionId, type SessionEvent, type TurnEndReason } from '@truly-private/omdsh-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@truly-private/omdsh-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@truly-private/omdsh-subagent'
import { scrubbedParentEnv } from '@truly-private/omdsh-subprocess'
