 ...
 * (`@truly-private/omdsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@truly-private/omdsh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@truly-private/omdsh-tools'
import type { ContentBlock, MessageId } from '@truly-private/omdsh-llm'
