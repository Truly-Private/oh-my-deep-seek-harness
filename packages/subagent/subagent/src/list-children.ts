...
import type { SessionProjectionRegistry } from '@truly-private/omdsh-session-projection'
import type { SessionProjectionCache } from '@truly-private/omdsh-session-projection-cache'
...
async function prepareListing(
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @truly-private/omdsh-session)',
