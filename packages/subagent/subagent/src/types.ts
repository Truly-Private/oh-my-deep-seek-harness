 ...
 *
 * @module @truly-private/omdsh-subagent/types
 */

import type { Agent, AgentOptions } from '@truly-private/omdsh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@truly-private/omdsh-tools'
