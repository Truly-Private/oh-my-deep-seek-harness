/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-subagent-control`.
 * @module @truly-private/omdsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-subagent-control'
