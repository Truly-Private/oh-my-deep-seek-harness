 ...
 * @module @truly-private/omdsh-tool-subagent-control/list-agents
 */
...
import type { SubagentDescendantListEntry, SubagentListEntry } from '@truly-private/omdsh-subagent'
