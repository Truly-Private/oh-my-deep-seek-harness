/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-subagent-report`.
 * @module @truly-private/omdsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-subagent-report'
