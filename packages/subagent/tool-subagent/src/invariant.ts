/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-subagent`.
 * @module @truly-private/omdsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-subagent'
