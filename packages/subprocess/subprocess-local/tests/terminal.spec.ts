...
import { LocalTerminalHandle } from '@truly-private/omdsh-subprocess-local/src/terminal.ts'
import type {
  ProcessIdentity,
  ProcessInspector,
} from '@truly-private/omdsh-subprocess-local/src/process-inspector.ts'
import type { SubprocessTerminalSignal } from '@truly-private/omdsh-subprocess'
