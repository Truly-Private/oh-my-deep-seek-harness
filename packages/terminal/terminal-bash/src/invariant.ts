/**
 * Package-owned invariant companion for `@truly-private/omdsh-terminal-bash`.
 * @module @truly-private/omdsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-terminal-bash'
