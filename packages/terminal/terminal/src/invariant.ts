/**
 * Package-owned invariant companion for `@truly-private/omdsh-terminal`.
 * @module @truly-private/omdsh-terminal/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-terminal'
