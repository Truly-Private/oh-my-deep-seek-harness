 ...
 * @module @truly-private/omdsh-tool-terminal
 */
...
import { TerminalSessionId } from '@truly-private/omdsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@truly-private/omdsh-terminal'
import type {} from '@truly-private/omdsh-jobs'
import { defineTool } from '@truly-private/omdsh-tools'
import type { ToolDefinition } from '@truly-private/omdsh-tools'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @truly-private/omdsh-jobs and @truly-private/omdsh-tool-jobs')
