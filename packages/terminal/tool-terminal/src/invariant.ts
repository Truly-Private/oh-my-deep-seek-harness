/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-terminal`.
 * @module @truly-private/omdsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-terminal'
