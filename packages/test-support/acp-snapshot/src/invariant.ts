/**
 * Package-owned invariant companion for `@truly-private/omdsh-acp-snapshot`.
 * @module @truly-private/omdsh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-acp-snapshot'
