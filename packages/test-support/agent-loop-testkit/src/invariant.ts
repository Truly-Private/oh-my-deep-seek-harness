/**
 * Package-owned invariant companion for `@truly-private/omdsh-agent-loop-testkit`.
 * @module @truly-private/omdsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-agent-loop-testkit'
