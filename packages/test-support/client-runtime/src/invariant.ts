/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-test-runtime`.
 * @module @truly-private/omdsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-test-runtime'
