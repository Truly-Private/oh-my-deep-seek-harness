/**
 * Package-owned invariant companion for `@truly-private/omdsh-llm-mock-server`.
 * @module @truly-private/omdsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-llm-mock-server'
