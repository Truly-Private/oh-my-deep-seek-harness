/**
 * Package-owned invariant companion for `@truly-private/omdsh-llm-replay`.
 * @module @truly-private/omdsh-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-llm-replay'
