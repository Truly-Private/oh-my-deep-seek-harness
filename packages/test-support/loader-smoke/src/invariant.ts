/**
 * Package-owned invariant companion for `@truly-private/omdsh-loader-smoke`.
 * @module @truly-private/omdsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-loader-smoke'
