/**
 * Package-owned invariant companion for `@truly-private/omdsh-typert-generator`.
 * @module @truly-private/omdsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-typert-generator'
