/**
 * Package-owned invariant companion for `@truly-private/omdsh-typert-protocol`.
 * @module @truly-private/omdsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-typert-protocol'
