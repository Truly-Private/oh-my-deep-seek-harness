/**
 * Package-owned invariant companion for `@truly-private/omdsh-typert-registry`.
 * @module @truly-private/omdsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-typert-registry'
