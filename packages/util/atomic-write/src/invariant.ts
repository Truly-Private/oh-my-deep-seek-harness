/**
 * Package-owned invariant companion for `@truly-private/omdsh-atomic-write`.
 * @module @truly-private/omdsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-atomic-write'
