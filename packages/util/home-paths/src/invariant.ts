/**
 * Package-owned invariant companion for `@truly-private/omdsh-home-paths`.
 * @module @truly-private/omdsh-home-paths/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-home-paths'
