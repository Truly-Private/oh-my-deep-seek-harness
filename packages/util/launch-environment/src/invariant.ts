/**
 * Package-owned invariant companion for `@truly-private/omdsh-launch-environment`.
 * @module @truly-private/omdsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-launch-environment'
