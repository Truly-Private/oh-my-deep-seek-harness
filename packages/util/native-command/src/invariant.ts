/**
 * Package-owned invariant companion for `@truly-private/omdsh-native-command`.
 * @module @truly-private/omdsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-native-command'
