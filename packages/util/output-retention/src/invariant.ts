/**
 * Package-owned invariant companion for `@truly-private/omdsh-output-retention`.
 * @module @truly-private/omdsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-output-retention'
