/**
 * Package-owned invariant companion for `@truly-private/omdsh-timeout`.
 * @module @truly-private/omdsh-timeout/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-timeout'
