...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@truly-private/omdsh-tools'
import type { WebFetchBody, WebFetchResult } from '@truly-private/omdsh-web'
 ...
 * `@truly-private/omdsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@truly-private/omdsh-tool-call-timeout-policy` to enforce.
