/**
 * Package-owned invariant companion for `@truly-private/omdsh-web-search-deepseek`.
 * @module @truly-private/omdsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-web-search-deepseek'
