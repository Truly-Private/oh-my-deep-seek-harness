 ...
 * @module @truly-private/omdsh-web-search-deepseek/provider
 */
...
import type {
  ...
  WebSearchResult,
  WebSearchSource,
} from '@truly-private/omdsh-web'
import type { CredentialRef } from '@truly-private/omdsh-credentials'
import type {} from '@truly-private/omdsh-session'
import type {
  AnthropicError,
  AnthropicResponse,
  ContentBlock,
 ...
 * (`https://api.deepseek.com`) `@truly-private/omdsh-llm-deepseek` uses, so this
