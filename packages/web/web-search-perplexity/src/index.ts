/**
 * `@truly-private/omdsh-web-search-perplexity`: registers a Perplexity-backed
 * `WebSearchProvider` with `ctx.web`. A function/namespace plugin (NOT a
 * default-export service): it registers INTO the seam's provider registry, like
 * `@truly-private/omdsh-llm-deepseek` registers an adapter into `ctx.llm`.
 *
 * @module @truly-private/omdsh-web-search-perplexity
 */
