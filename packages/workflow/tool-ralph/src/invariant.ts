/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-ralph`.
 * @module @truly-private/omdsh-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-ralph'
