/** Package-owned durable workflow-record invariants. @module @truly-private/omdsh-tool-workflow/invariant */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-workflow'
