/**
 * Package-owned invariant companion for `@truly-private/omdsh-workflow-worker-thread`.
 * @module @truly-private/omdsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-workflow-worker-thread'
