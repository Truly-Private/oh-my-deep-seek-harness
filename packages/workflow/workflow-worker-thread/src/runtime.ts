 ...
 * @module @truly-private/omdsh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@truly-private/omdsh-llm'
import { SessionId } from '@truly-private/omdsh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@truly-private/omdsh-tools'
import type { ObjectJsonSchema } from '@truly-private/omdsh-tools'
import { isFatalWorkflowError, WorkflowError } from '@truly-private/omdsh-workflow'
import type {
