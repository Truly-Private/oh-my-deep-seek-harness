...
- id: session-checkpoints
  name: '@truly-private/omdsh-session-checkpoint-policy'
- id: subprocess
...
def test_bundled_runtime_surfaces_unbundled_plugin_failure(tmp_path: Path, mode: str) -> None:
    ...
    (tmp_path / "cordis.yml").write_text(
        "- id: missing\n  name: '@truly-private/omdsh-does-not-exist'\n"
    )
    ...
    assert "@truly-private/omdsh-does-not-exist" in str(excinfo.value)
