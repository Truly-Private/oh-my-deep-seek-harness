...
import type { CordisCatalogModel, ServiceMethodEntry } from '@truly-private/omdsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@truly-private/omdsh-tool-cordis/api-catalog', '@truly-private/omdsh-cordis-client-runner/client/api-catalog')
