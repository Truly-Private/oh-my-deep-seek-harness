...
function workspaceFixture(options: {
  ...
  writeJson(join(shared, 'package.json'), { name: '@truly-private/omdsh-shared' })
  writeJson(join(shared, 'tsconfig.json'), {
    extends: '../../../tsconfig.base.json',
    references: [],
  })
  writeJson(join(split, 'package.json'), { name: '@truly-private/omdsh-split' })
...
describe('Project Reference compiler faces', () => {
  ...
  it('uses the referencing project face throughout the reachable graph', () => {
    ...
    writeJson(join(hostConsumer, 'package.json'), { name: '@truly-private/omdsh-host-consumer' })
    ...
    writeJson(join(clientConsumer, 'package.json'), { name: '@truly-private/omdsh-client-consumer' })
